                                        ...
                                        @if(Auth::user()->utype === 'ADM')
                                            <li class="menu-item menu-item-has-children parent" >
                                                ...
                                                <ul class="submenu curency" >
                                                    ...
                                                    <li class="menu-item" >
                                                        <a title="Categories" href="{{route('admin.categories')}}">All Categories</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a title="Sliders" href="{{ route('admin.sliders')}}"> All Sliders</a>
                                                    </li>
                                                    <li class="menu-item" >
                                                    ...
                                                    <li class="menu-item" >
                                                        <a title="All Sellers" href="{{ route('admin.sellers') }}" >All Sellers</a>
                                                    </li>
                                                    <li class="menu-item" >
                                                        <a title="All Coupons" href="{{ route('admin.coupons') }}" >All Coupons</a>
                                                    </li>
                                                    <li class="menu-item" >
                                                        <a title="All Coupons" href="{{ route('admin.orders') }}" >All Orders</a>
                                                    </li>
                                                    <li class="menu-item" >
                                                        <a title="Contact Messages" href="{{ route('admin.contact') }}" >Contact Messages</a>
                                                    </li>
                                                    <li class="menu-item" >
                                                        <a title="Setting" href="{{ route('admin.settings') }}" >Setting</a>
                                                    </li>
                                                    <li class="menu-item" >
                                        ...
                                        @else
                                            <li class="menu-item menu-item-has-children parent" >
                                                ...
                                                <ul class="submenu curency" >
                                                    ...
                                                    <li class="menu-item" >
                                                        <a title="Create Shop" href="{{route('create.shop')}}">Create Shop</a>
                                                    </li>
                                                    <li class="menu-item" >
                                                        <a title="My Orders23" href="{{route('customer.orders')}}">My Orders</a>
                                                    </li>
                                                    <li class="menu-item" >
                                                            <a title="Logout" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a>
                                                    </li>
                                                    ...
                                                    <li class="menu-item" >
                                                        <a title="Dashboard" href="#">Customer</a>
                                                    </li>
                                                </ul>
                                            </li>
                                        @endif
