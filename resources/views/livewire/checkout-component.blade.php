                            ...
                            <div class="col-md-12">
                                <div class="wrap-address-billing">
                                    ...
                                    <div class="billing-address">
                                        ...
                                        <p class="row-in-form">
                                            <label for="city">Town / City<span>*</span></label>
                                            <input type="text" name="city" value="" placeholder="City name" wire:model="s_country">
                                            @error('s_country') <span class="text-danger">{{$message}}</span> @enderror
                                        </p>
                                    </div>
                                </div>
                    ...
                    <div class="summary summary-checkout">
                        <div class="summary-item payment-method">
                            ...
                            <div class="choose-payment-methods">
                                ...
                                <label class="payment-method">
                                    <input name="payment-method" id="payment-method-visa" value="bkash" type="radio" wire:model="paymentmode">
                                    <span>Bkash</span>
                                    <span class="payment-desc">Order Now Pay on Bkash</span>
                                </label>
                                <label class="payment-method">
                                    <input name="payment-method" id="payment-method-paypal" value="nagad" type="radio" wire:model="paymentmode">
                                    <span>Nagad</span>
                                    <span class="payment-desc">Order Now Pay on Bkash</span>
                                </label>
