                    ...
                    @foreach ($sproducts as $sproduct)
                        <div class="product product-style-2 equal-elem ">
                            ...
                            <div class="product-info">
                                ...
                                <div class="wrap-price"><ins><p class="product-price">${{$sproduct->sa_price}}</p></ins> <del><p class="product-price">${{$sproduct->re_price}}</p></del></div>
                            </div>
                        </div>
                    @endforeach
				</div>
                                    ...
                                    @foreach ($lproducts as $lproduct)
                                        <div class="product product-style-2 equal-elem ">
                                            ...
                                            <div class="product-info">
                                                ...
                                                <div class="wrap-price"><span class="product-price">${{$lproduct->re_price}}</span></div>
                                            </div>
                                        </div>
                                    @endforeach
								</div>
                                    ...
                                    @foreach ($c_products as $c_product)
                                        <div class="product product-style-2 equal-elem ">
                                            ...
                                            <div class="product-info">
                                                ...
                                                <div class="wrap-price"><span class="product-price">${{$c_product->re_price}}</span></div>
                                            </div>
                                        </div>
                                    @endforeach
								</div>
