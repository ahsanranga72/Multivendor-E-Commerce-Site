            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                <div class="wrap-product-detail">
                    ...
                    <div class="detail-info">
                        ...
                        @if ($product->sa_price > 0 && $sale->status == 1 && $sale->sale_date > Carbon\Carbon::now())
                            <div class="wrap-price"><span><p class="product-price">${{$product->sa_price}}</p></span> <del><p class="product-price regprice">${{$product->re_price}}</p></del></div>
                        @else
                            <div class="wrap-price"><span class="product-price">${{ $product->re_price }}</span></div>
                        @endif
                        ...
                        <div class="wrap-butons">
                            @if ($product->sa_price > 0 && $sale->status == 1 && $sale->sale_date > Carbon\Carbon::now())
                                <a href="#" class="btn add-to-cart" wire:click.prevent="store({{$product->id}}, '{{$product->name}}',{{$product->sa_price}})">Add to Cart</a>
                            @else
                                <a href="#" class="btn add-to-cart" wire:click.prevent="store({{$product->id}}, '{{$product->name}}',{{$product->re_price}})">Add to Cart</a>
                            @endif
                            <div class="wrap-btn">
                                ...
                                <li class="product-item">
                                    <div class="product product-widget-style">
                                        ...
                                        <div class="product-info">
                                            ...
                                            <div class="wrap-price"><span class="product-price">${{ $p_product->re_price }}</span></div>
                                        </div>
                                    </div>
                                </li>
                            @endforeach
                            ...
                            @foreach ($related_products as $r_product)
                                <div class="product product-style-2 equal-elem ">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="wrap-price"><span class="product-price">${{ $r_product->re_price }}</span></div>
                                    </div>
                                </div>
                            @endforeach
                        </div>
