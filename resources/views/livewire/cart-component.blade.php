                        ...
                        <ul class="products-cart">
                            @foreach (Cart::instance('cart')->content() as $item)
                                <li class="pr-cart-item">
                                    ...
                                    <div class="price-field produtc-price"><p class="price">${{ $item->model->re_price }}</p></div>
                                    <div class="quantity">
				...
				<div class="summary">
					<div class="order-summary">
                        ...
                        @if (Session::has('coupon'))
						    <p class="summary-info"><span class="title">Discount ({{Session::get('coupon')['code']}}) <a href="#" wire:click.prevent="removecoupon"><i class="fa fa-times text-danger"></i></a></span><b class="index"> - ${{$discount}}</b></p>
                            ...
                            @if($haveCouponCode == 1)
                                <div class="summary-item">
                                    <form wire:submit.prevent="applyCouponCode">
                                        ...
                                        @if (Session::has('coupon-massage'))
                                            <div class="alert alert-danger" role="alert">{{Session::get('coupon-massage')}}</div>
                                        @endif
                                        <p class="row-in-form">
